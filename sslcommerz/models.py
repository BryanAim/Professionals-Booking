...
from professional.models import Appointment, testOrder, ServiceRequest
...
class Payment(models.Model):
    ...
    # serviceRequest = models.ForeignKey(ServiceRequest, on_delete=models.SET_NULL, null=True, blank=True)
