    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.CharField(choices=[('medical', 'Medical Services'), ('legal', 'Legal Services'), ('engineering', 'Engineering Services'), ('art', 'Art & Design'), ('tech', 'Technology Services'), ('education', 'Educational Services'), ('consulting', 'Consulting Services')], max_length=200)),
            ],
        ),
        migrations.CreateModel(
            name='Client',
