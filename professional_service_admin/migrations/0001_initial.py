    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professional_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='professional_service.professional_service_information')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professional_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='professional_service.professional_service_information')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.IntegerField(blank=True, null=True)),
                ('email', models.EmailField(blank=True, max_length=200, null=True)),
                ('role', models.CharField(blank=True, choices=[('professional_service', 'Professional Service'), ('laboratory', 'Laboratory'), ('store', 'Store'), ('legal', 'Legal Services'), ('engineering', 'Engineering Services')], max_length=200, null=True)),
                ('professional_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='professional_service.professional_service_information')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='professional_service_admin', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
