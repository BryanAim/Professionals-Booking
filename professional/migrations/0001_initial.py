# Generated by Django 4.1.10 on 2024-04-02 06:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='service_provider.client')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prescription', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='professional.prescription')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('featured_image', models.ImageField(blank=True, default='professionals/user-default.png', null=True, upload_to='professionals/')),
                ('certificate_image', models.ImageField(blank=True, default='professionals_certificate/default.png', null=True, upload_to='professionals_certificate/')),
                ...
                ('department_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='service_provider_admin.ServiceDepartment')),
                ('service_provider_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='service_provider.service_provider_information')),
                ('specialization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='service_provider_admin.specialization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professional', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='professional.professional_information')),
            ],
        ),
        migrations.CreateModel(
            name='testCart',
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='professional.prescription_test')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.CharField(blank=True, max_length=200, null=True)),
                ('referred_value', models.CharField(blank=True, max_length=200, null=True)),
                ('report', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='professional.report')),
            ],
        ),
        migrations.CreateModel(
            name='Specimen',
