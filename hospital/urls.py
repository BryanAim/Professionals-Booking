...
urlpatterns = [
    ...
    path('chat-professional/', views.chat_doctor, name='chat-professional'),
    ...
    path('hospital-professional-list/<int:pk>/', views.hospital_doctor_list, name='hospital-professional-list'),
    path('hospital-professional-register/<int:pk>/', views.hospital_doctor_register, name='hospital-professional-register'),
