    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_type', models.CharField(choices=[('medical', 'Medical Services'), ('legal', 'Legal Services'), ('engineering', 'Engineering Services'), ('art', 'Art & Design')], max_length=200)),
                ('featured_image', models.ImageField(default='professionals/default.png', upload_to='professionals/')),
                ('certificate_image', models.ImageField(blank=True, default='certificates/default.png', null=True, upload_to='certificates/')),
                ...
                ('department', models.CharField(blank=True, choices=[('medical', 'Medical Services'), ('legal', 'Legal Services'), ('engineering', 'Engineering Services'), ('art', 'Art & Design')], max_length=200, null=True)),
