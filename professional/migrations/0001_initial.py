    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_type', models.CharField(choices=[('consultation_app', 'Consultation'), ('service_app', 'Service')], max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profession', models.CharField(blank=True, choices=[('medical', 'Medical Services'), ('legal', 'Legal Services'), ('engineering', 'Engineering Services'), ('art', 'Art & Design')], max_length=200, null=True)),
                ('services_fee', models.IntegerField(blank=True, null=True)),
                ('institute', models.CharField(blank=True, max_length=200, null=True)),
                ('degree', models.CharField(blank=True, max_length=200, null=True)),
