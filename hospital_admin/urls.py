...
urlpatterns = [
    ...
    path('register-professional-list/', views.register_doctor_list,name='register-professional-list'),
    path('pending-professional-list/', views.pending_doctor_list,name='pending-professional-list'),
    ...
    path('admin-professional-profile/<int:pk>/', views.admin_doctor_profile,name='admin-professional-profile'),
    path('accept-professional/<int:pk>/', views.accept_doctor,name='accept-professional'),
    path('reject-professional/<int:pk>/', views.reject_doctor,name='reject-professional'),
