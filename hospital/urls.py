...
urlpatterns = [
    ...
    path('hospital-professional-list/<int:pk>/', views.hospital_professional_list, name='hospital-professional-list'),
    path('hospital-professional-register/<int:pk>/', views.hospital_professional_register, name='hospital-professional-register'),
